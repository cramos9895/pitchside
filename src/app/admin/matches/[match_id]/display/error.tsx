...
export default function ErrorBoundary({
    ...
    useEffect(() => {
        // Log the error
        console.error("Match Display Route Error:", error);
        ...
        if (
            ...
            console.warn("Transient AbortError detected in match display. Resetting route...");
            reset();
        }
    }, [error, reset]);
    ...
    return (
        <div className="min-h-screen bg-black flex flex-col items-center justify-center text-pitch-accent gap-4 p-6 text-center">
            ...
            <h2 className="text-xl font-bold uppercase tracking-widest">Reconnecting to Match Feed...</h2>
