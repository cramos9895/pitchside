...
export default function CreateRollingLeaguePage() {
    return (
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black italic uppercase tracking-tighter text-white">
                        Provision <span className="text-pitch-accent">Rolling League</span>
                    </h1>
                    <p className="text-pitch-secondary mt-2">
                        Create an open, flexible rolling league format with automated lifecycle management.
                    </p>
                </div>
