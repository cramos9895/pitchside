...
import { CheckCircle2, Trophy, ArrowRight, ShieldCheck, Info, Loader2, Lock } from 'lucide-react';
...
interface LeagueInviteClientProps {
    teamId: string;
    teamName: string;
    leagueId: string;
    leagueName: string;
...
export function LeagueInviteClient({ 
    teamId, 
    teamName, 
    leagueId, 
    leagueName, 
            ...
            <div className="relative z-10">
                <div className="mb-8 border-b border-white/10 pb-6 uppercase">
                    ...
                    <p className="text-pitch-secondary text-sm font-bold tracking-widest">
                        Invited by <span className="text-pitch-accent">{captainName}</span> for {leagueName}
                    </p>
                </div>
                    ...
                    {/* The Notice */}
                     <div className="p-6 bg-white/5 rounded-xl border border-white/5 space-y-4">
                        <div className="flex items-center gap-3 text-white">
                            ...
                            <span className="font-black uppercase tracking-widest text-sm">League Roster Guidelines</span>
                        </div>
                            ...
                            <>
                                <p className="text-gray-400 text-sm font-medium leading-relaxed">
                                    {isFullPay 
                                        ...
                                        : `This team is using Split-Pay. Each rostered player will cover an equal portion of the league fee of $${totalFee}.`}
                                </p>
...
function LeagueSetupIntentForm({ teamId, leagueId, setupIntentId, waiverAccepted, onError }: { teamId: string, leagueId: string, setupIntentId: string, waiverAccepted: boolean, onError: (msg: string) => void }) {
