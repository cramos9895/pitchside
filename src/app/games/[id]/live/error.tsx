...
export default function ErrorBoundary({
    ...
    useEffect(() => {
        // Log the error
        console.error("Live Projector Route Error:", error);
        ...
        if (
            ...
            console.warn("Transient AbortError detected in live projector. Resetting route...");
            reset();
        }
    }, [error, reset]);
    ...
    return (
        <div className="min-h-screen bg-black flex flex-col items-center justify-center text-pitch-accent gap-4 p-6 text-center">
            ...
            <h2 className="text-xl font-bold uppercase tracking-widest">Reconnecting to Live Scoreboard...</h2>
