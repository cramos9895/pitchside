...
interface TournamentFreeAgentViewProps {
    game: RollingLeague;
...
export function TournamentFreeAgentView({ game, primaryHost, registeredTeams = [], currentUserId }: TournamentFreeAgentViewProps) {
