                            ...
                            <div className="p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                                ...
                                <div className="flex-1 w-full grid grid-cols-[1fr_auto_1fr] items-center gap-3 md:gap-8">
                                    ...
                                    <div className="text-right flex flex-col items-end">
                                        <span className={cn(
                                            "text-xs md:text-sm font-black uppercase italic tracking-tighter truncate w-full",
                                    ...
                                    {/* Score Box */}
                                    <div className="bg-black/40 border border-white/5 rounded px-4 md:px-6 py-2 flex items-center gap-3 md:gap-4 shadow-inner relative">
                                        <span className={cn(
                                        ...
                                        <span className="text-white/5 font-black text-xs">VS</span>
                                        <span className={cn(
                                            "text-xl md:text-2xl font-black italic",
                                ...
                                {/* Metadata */}
                                <div className="flex items-center justify-center gap-6 md:border-l md:border-white/10 md:pl-8 shrink-0">
                                    {m.field_name && (
