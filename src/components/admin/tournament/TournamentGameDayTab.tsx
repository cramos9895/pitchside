...
import { toggleCashPayment, resetCashTracker } from '@/app/actions/tournament-god-mode';
...
export function TournamentGameDayTab({ registrations, teams, gameId, game, onRefresh }: any) {
