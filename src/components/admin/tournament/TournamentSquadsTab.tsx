...
import { createManualTeam, updateTeamDetails, transferPlayer, draftAutoTeam, searchProfiles, addManualPlayer, moveToFreeAgency, removeFromLeague, issuePermanentBan, issueSoftBan, deleteTeam } from '@/app/actions/tournament-god-mode';
...
export function TournamentSquadsTab({ registrations, teams, gameId, game, onRefresh }: any) {
